package com.dimi.moviedatabase.business.interactors
...
object SharedUseCasesKeys {
    ...
    const val USE_CASE_RECOMMENDED_MEDIA = "Successfully retrieved recommendations."

    const val MESSAGE_DETAILS_QUERY_SUCCESSFUL = "Successfully retrieved details."
}